...
#     Salam, hər vaxtınız xeyir. Bugünün taskları. Nəsə bir sualınız olsa soruşun.
...
# elifbayauygun = ''.join(sorted(cumle))
# print( elifbayauygun)
...
#     x_ci_cehd += 1
#     print(f"{x_ci_cehd}. cehd: {eded}")

#     if eded == n:
#         print("Təbriklər!" , x_ci_cehd, "cehdde 15 reqemini tapdiz")
#         break
...
# for eded in range(2, 101):  
#     sade = True
#     for bolen in range(2, int(eded ** 0.5) + 1):
#         if eded % bolen == 0:
#             sade = False
#             break
#     if sade:
